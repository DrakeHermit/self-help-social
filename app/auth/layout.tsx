...
export default function AuthLayout({
  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-[#2a221b] via-[#33271e] to-[#1f1814] p-10 text-[#f1e7d9] lg:flex xl:p-14">
        <div
          aria-hidden
        ...
        <Link
          ...
          className="relative z-10 flex w-fit items-center gap-3 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
        >
        ...
        <p className="relative z-10 text-xs text-[#8a7b69]">
